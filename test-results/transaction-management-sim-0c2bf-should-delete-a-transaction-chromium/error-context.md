    ...
    - table:
      - rowgroup:
        - row "Date Description Category Amount Actions":
          ...
          - cell "Actions"
      - rowgroup:
        - row "Jan 15, 2024 To Keep Transportation $35.00":
          - cell "Jan 15, 2024"
          - cell "To Keep"
          - cell "Transportation"
          - cell "$35.00"
        ...
        - row "Jul 14, 2025 Monthly Income Salary +$17,800.00":
          ...
          - cell:
            ...
            - button:
              - img
    - text: "Total Transactions: 7 Total: $19,715.00"
- region "Notifications (F8)":
  - list:
    - status:
      - text: Success Transaction deleted successfully
      - button:
        - img
- alert
- img
...
- button "Hide Errors":
  - img
- status: Notification SuccessTransaction deleted successfully
```