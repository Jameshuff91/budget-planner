...
- main:
  ...
  - tabpanel "Settings":
    ...
    - switch "Enable Smart Categorization" [checked]
    - text: OpenAI API Key
    ...
    - text: Model
    - combobox "Model":
      - option "GPT-3.5 Turbo (Fast & Affordable)" [selected]
      - option "GPT-4 (Most Accurate)"
      - option "GPT-4 Turbo (Fast & Accurate)"
    - paragraph: GPT-3.5 is recommended for most use cases due to lower cost
...
- text: FCP is 4328.00 (poor) Check performance optimization guides TTFB is 3212.00 (poor) Optimize server response time and use CDN LCP is 4339.00 (poor) Optimize images and critical resources loading
