...
- region "Notifications (F8)":
  - list:
    - status:
      - text: Notifications Enabled You will receive budget alerts as notifications
      - button:
        - img
- alert
- status: Notification Notifications EnabledYou will receive budget alerts as notifications
```