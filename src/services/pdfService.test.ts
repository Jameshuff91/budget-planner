...
describe('PDFService', () => {
  ...
  describe('parseCurrencyAmount', () => {
    ...
    it('should parse negative value: "-100.00"', () => {
      expect(pdfService['parseCurrencyAmount']('-100.00')).toBe(-100.00);
    });
    ...
    it('should handle OCR error "S12.B0" for 512.80', () => {
      expect(pdfService['parseCurrencyAmount']('S12.B0')).toBe(512.80);
    });
    ...
    it('should return 0 for empty input: ""', () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('Input amount string is empty or invalid'));
    });

    it('should handle number with only decimals: ".50"', () => {
      expect(pdfService['parseCurrencyAmount']('.50')).toBe(0.50);
    });
    ...
    it('should handle amount with trailing hyphen: "50.00-"', () => {
      expect(pdfService['parseCurrencyAmount']('50.00-')).toBe(-50.00);
    });
    ...
    it('should handle large numbers correctly: "10,000.00"', () => {
      expect(pdfService['parseCurrencyAmount']('10,000.00')).toBe(10000.00);
    });
    ...
    it('should return 0 for amounts exceeding MAX_AMOUNT: "200000.00"', () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('is outside the reasonable range'));
      expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('remains outside reasonable limits'));
    });
  ...
  describe('classifyTransaction', () => {
    ...
    it('should classify "Subscription Fee for Netflux" as expense', () => {
      expect(pdfService['classifyTransaction']('Subscription Fee for Netflux', -15)).toBe('expense');
    });
    ...
    it('should classify "Utility Bill Payment" as expense', () => {
     ...
     it('should classify "Shell Pur" as expense', () => { // Testing 'pur' with word boundary
    ...
    it('should classify "Venmo to Jane Smith for dinner" as expense', () => {
      expect(pdfService['classifyTransaction']('Venmo to Jane Smith for dinner', -20)).toBe('expense');
    });
  ...
  describe('determineExpenseCategory', () => {
    ...
    // Groceries
    it('should categorize "TRADER JOE\'S PURCHASE" as Groceries', () => testCategory("TRADER JOE'S PURCHASE", 'Groceries'));
    it('should categorize "WHOLE FOODS MARKET" as Groceries', () => testCategory("WHOLE FOODS MARKET", 'Groceries'));
    it('should categorize "SAFEWAY STORE 123" as Groceries', () => testCategory("SAFEWAY STORE 123", 'Groceries'));
    it('should categorize "Grocery outlet" as Groceries', () => testCategory("Grocery outlet", 'Groceries'));


    // Utilities
    it('should categorize "PG&E Bill Payment" as Utilities', () => testCategory("PG&E Bill Payment", 'Utilities'));
    it('should categorize "Comcast Internet Services" as Utilities', () => testCategory("Comcast Internet Services", 'Utilities'));
    it('should categorize "Verizon Fios Bill" as Utilities', () => testCategory("Verizon Fios Bill", 'Utilities'));
    it('should categorize "City Water Bill" as Utilities', () => testCategory("City Water Bill", 'Utilities'));


    // Transport
    it('should categorize "Uber Ride Home" as Transport', () => testCategory("Uber Ride Home", 'Transport'));
    it('should categorize "Lyft to Airport" as Transport', () => testCategory("Lyft to Airport", 'Transport'));
    it('should categorize "SHELL GASOLINE PURCHASE" as Transport', () => testCategory("SHELL GASOLINE PURCHASE", 'Transport'));
    it('should categorize "Parking Fee Downtown" as Transport', () => testCategory("Parking Fee Downtown", 'Transport'));

    // Entertainment
    it('should categorize "Netflix Subscription" as Entertainment', () => testCategory("Netflix Subscription", 'Entertainment'));
    it('should categorize "Spotify Premium" as Entertainment', () => testCategory("Spotify Premium", 'Entertainment'));
    it('should categorize "Regal Cinema Ticket" as Entertainment', () => testCategory("Regal Cinema Ticket", 'Entertainment'));
    it('should categorize "Starbucks Coffee" as Entertainment', () => testCategory("Starbucks Coffee", 'Entertainment'));
    it('should categorize "Dining at The Great Restaurant" as Entertainment', () => testCategory("Dining at The Great Restaurant", 'Entertainment'));


    // Healthcare
    it('should categorize "CVS Pharmacy Prescription" as Healthcare', () => testCategory("CVS Pharmacy Prescription", 'Healthcare'));
    it('should categorize "Walgreens Store" as Healthcare', () => testCategory("Walgreens Store", 'Healthcare'));
    it('should categorize "Doctor Visit Co-pay" as Healthcare', () => testCategory("Doctor Visit Co-pay", 'Healthcare'));
    it('should categorize "Dental Cleaning Service" as Healthcare', () => testCategory("Dental Cleaning Service", 'Healthcare'));


    // Shopping
    it('should categorize "Amazon Purchase" as Shopping', () => testCategory("Amazon Purchase", 'Shopping'));
    it('should categorize "Target Store Shopping" as Shopping', () => testCategory("Target Store Shopping", 'Shopping'));
    it('should categorize "Best Buy Electronics" as Shopping', () => testCategory("Best Buy Electronics", 'Shopping'));

    // Education
    it('should categorize "University Tuition Fee" as Education', () => testCategory("University Tuition Fee", 'Education'));
    it('should categorize "Coursera Course Subscription" as Education', () => testCategory("Coursera Course Subscription", 'Education'));
    it('should categorize "Campus Bookstore Purchase" as Education', () => testCategory("Campus Bookstore Purchase", 'Education'));


    // Home Improvement
    it('should categorize "Home Depot Supplies" as Home Improvement', () => testCategory("Home Depot Supplies", 'Home Improvement'));
    it('should categorize "Lowe\'s Hardware" as Home Improvement', () => testCategory("Lowe's Hardware", 'Home Improvement'));

    // Personal Care
    it('should categorize "Super Salon Haircut" as Personal Care', () => testCategory("Super Salon Haircut", 'Personal Care'));
    it('should categorize "Barbershop Trim" as Personal Care', () => testCategory("Barbershop Trim", 'Personal Care'));

    // Insurance
    it('should categorize "State Farm Auto Insurance" as Insurance', () => testCategory("State Farm Auto Insurance", 'Insurance'));
    it('should categorize "Geico Premium Payment" as Insurance', () => testCategory("Geico Premium Payment", 'Insurance'));
    it('should categorize "Health Insurance Premium (outside Healthcare keywords)" as Insurance', () => testCategory("Health Insurance Premium ABC", 'Insurance'));


    // Childcare
    it('should categorize "Bright Horizons Daycare Payment" as Childcare', () => testCategory("Bright Horizons Daycare Payment", 'Childcare'));
    it('should categorize "Preschool Monthly Fee" as Childcare', () => testCategory("Preschool Monthly Fee", 'Childcare'));

    // Pet Care
    it('should categorize "Petco Dog Food" as Pet Care', () => testCategory("Petco Dog Food", 'Pet Care'));
    it('should categorize "Petsmart Toys" as Pet Care', () => testCategory("Petsmart Toys", 'Pet Care'));
    it('should categorize "Veterinarian Visit for Fluffy" as Pet Care', () => testCategory("Veterinarian Visit for Fluffy", 'Pet Care'));


    // Gifts & Donations
    it('should categorize "Birthday Gift for Mom" as Gifts & Donations', () => testCategory("Birthday Gift for Mom", 'Gifts & Donations'));
    it('should categorize "Donation to Red Cross" as Gifts & Donations', () => testCategory("Donation to Red Cross", 'Gifts & Donations'));
    it('should categorize "Charity Contribution" as Gifts & Donations', () => testCategory("Charity Contribution", 'Gifts & Donations'));
    it('should categorize "Church Tithe" as Gifts & Donations', () => testCategory("Church Tithe", 'Gifts & Donations'));


    // Credit Card Payment
    it('should categorize "Payment to Chase Card ending 1234" as Credit Card Payment', () => testCategory("Payment to Chase Card ending 1234", 'Credit Card Payment'));
    it('should categorize "AMEX E-PAYMENT ONLINE" as Credit Card Payment', () => testCategory("AMEX E-PAYMENT ONLINE", 'Credit Card Payment'));
    it('should categorize "Online Payment Thank You - CITI CARD" as Credit Card Payment', () => testCategory("Online Payment Thank You - CITI CARD", 'Credit Card Payment'));
    it('should categorize "ACH PMT TO BANK OF AMERICA CREDIT CARD" as Credit Card Payment', () => testCategory("ACH PMT TO BANK OF AMERICA CREDIT CARD", 'Credit Card Payment'));
    it('should categorize "ACH PMT for Amazon Store Card" as Credit Card Payment', () => testCategory("ACH PMT for Amazon Store Card", 'Credit Card Payment'));
    it('should not categorize "ACH PMT for Rent" as Credit Card Payment', () => testCategory("ACH PMT for Rent", 'Rent')); // Assuming 'rent' takes precedence


    // Other Expenses (Fallback)
    it('should categorize "Unique Vendor LLC" as Other Expenses', () => testCategory("Unique Vendor LLC", 'Other Expenses'));
    it('should categorize "Miscellaneous item" as Other Expenses', () => testCategory("Miscellaneous item", 'Other Expenses'));
    it('should handle case-insensitivity: "NETFLIX" as Entertainment', () => testCategory("NETFLIX", 'Entertainment'));
  ...
  describe('parseDate', () => {
    ...
    const expectDate = (date: Date | null, year: number | null, month: number | null, day: number | null) => {
      if (year === null || month === null || day === null) {
        expect(date).toBeNull();
      } else {
        expect(date).not.toBeNull();
        if (date) { // TypeScript type guard
    ...
    // Supported Formats
    it('should parse MM/DD/YYYY: "01/15/2023"', () => expectDate(pdfService['parseDate']('01/15/2023'), 2023, 0, 15));
    it('should parse M/D/YYYY: "1/5/2023"', () => expectDate(pdfService['parseDate']('1/5/2023'), 2023, 0, 5));
    it('should parse MM-DD-YYYY: "01-15-2023"', () => expectDate(pdfService['parseDate']('01-15-2023'), 2023, 0, 15));
    it('should parse MM.DD.YYYY: "01.15.2023"', () => expectDate(pdfService['parseDate']('01.15.2023'), 2023, 0, 15));
    it('should parse MM/DD/YY: "01/15/23"', () => expectDate(pdfService['parseDate']('01/15/23'), 2023, 0, 15));
    it('should parse M/D/YY: "1/5/23"', () => expectDate(pdfService['parseDate']('1/5/23'), 2023, 0, 5));
    
    it('should parse Month DD, YYYY: "Jan 15, 2023"', () => expectDate(pdfService['parseDate']('Jan 15, 2023'), 2023, 0, 15));
    it('should parse Month DD YYYY (no comma): "January 15 2023"', () => expectDate(pdfService['parseDate']('January 15 2023'), 2023, 0, 15));
    it('should parse Mon. DD, YYYY: "Feb. 5, 2024"', () => expectDate(pdfService['parseDate']('Feb. 5, 2024'), 2024, 1, 5));
    
    it('should parse DD Month YYYY: "15 January 2023"', () => expectDate(pdfService['parseDate']('15 January 2023'), 2023, 0, 15));
    it('should parse DD Mon YYYY: "5 Feb 2024"', () => expectDate(pdfService['parseDate']('5 Feb 2024'), 2024, 1, 5));
    it('should parse DD Mon. YYYY: "05 Mar. 2023"', () => expectDate(pdfService['parseDate']('05 Mar. 2023'), 2023, 2, 5));

    it('should parse YYYY-MM-DD (ISO): "2023-03-20"', () => expectDate(pdfService['parseDate']('2023-03-20'), 2023, 2, 20));
    it('should parse YYYY/MM/DD: "2023/04/10"', () => expectDate(pdfService['parseDate']('2023/04/10'), 2023, 3, 10));
    it('should parse YYYY.MM.DD: "2023.05.01"', () => expectDate(pdfService['parseDate']('2023.05.01'), 2023, 4, 1));


    // MM/DD or M/D (assumes current year, corrected by validateAndCorrectDate)
    it('should parse MM/DD: "01/20"', () => expectDate(pdfService['parseDate']('01/20'), currentYear, 0, 20));
    it('should parse M/D: "3/5"', () => expectDate(pdfService['parseDate']('3/5'), currentYear, 2, 5));
    it('should parse M-D: "3-5"', () => expectDate(pdfService['parseDate']('3-5'), currentYear, 2, 5));
    it('should parse M.D: "3.5"', () => expectDate(pdfService['parseDate']('3.5'), currentYear, 2, 5));


    // Case-insensitivity for months
    it('should parse "jAn 15, 2023" (case-insensitive month)', () => expectDate(pdfService['parseDate']('jAn 15, 2023'), 2023, 0, 15));
    it('should parse "15 feB. 2023" (case-insensitive month)', () => expectDate(pdfService['parseDate']('15 feB. 2023'), 2023, 1, 15));

    // Whitespace handling
    it('should parse with leading/trailing spaces: " 04/25/2023 "', () => expectDate(pdfService['parseDate'](' 04/25/2023 '), 2023, 3, 25));
    it('should parse with extra spaces: "May   5 ,  2024"', () => expectDate(pdfService['parseDate']('May   5 ,  2024'), 2024, 4, 5));


    // Invalid Dates
    it('should return null for invalid date "99/99/9999"', () => {
        expect(pdfService['parseDate']('99/99/9999')).toBeNull();
        expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('Error parsing date string "99/99/9999"'), expect.anything());
    });
    it('should return null for "Not a date"', () => {
        expect(pdfService['parseDate']('Not a date')).toBeNull();
        expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('Error parsing date string "Not a date"'), expect.anything());
    });
    it('should return null for invalid day "02/30/2023"', () => {
        expect(pdfService['parseDate']('02/30/2023')).toBeNull();
         expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('Error parsing date string "02/30/2023"'), expect.anything());
    });
    it('should return null for empty string ""', () => {
        expect(pdfService['parseDate']('')).toBeNull();
        expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('Invalid date string provided: '));
    });
    it('should return null for invalid month name "NonExistentMonth 10, 2023"', () => {
        ...
        expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('Error parsing date string "NonExistentMonth 10, 2023"'), expect.anything());
    });
     it('should return null for "13/01/2023" (invalid month)', () => {
        expect(pdfService['parseDate']('13/01/2023')).toBeNull();
        expect(logger.error).toHaveBeenCalledWith(expect.stringContaining('Error parsing date string "13/01/2023"'), expect.anything());
    });
  });
  ...
  describe('validateAndCorrectDate', () => {
    ...
    it('should correct year based on statementPeriod (same year)', () => {
      ...
      if (currentYear !== 2023) { // Log only if year was actually changed
        expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('Adjusting transaction year'));
      }
    });
    ...
    it('should fallback to currentDate if no statementPeriod and date is in future', () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('is in the future. Assuming previous year'));
    });
    ...
    it('should not correct year if date is in past and no statementPeriod', () => {
      ...
      expect(logger.warn).not.toHaveBeenCalledWith(expect.stringContaining('Adjusting transaction year'));
    });
    ...
    it('should log warning if date is outside statement period after year correction', () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('is outside the statement period'));
    });
  ...
  describe('cleanDescription', () => {
    ...
    it('should handle a complex example with multiple rules', () => {
      const input = "CHECKCARD PURCHASE 01/22 THE HOME DEPOT #1234 ATLANTA GA P.O.S. DEBIT WEB ID: 56789 Amount: $55.00 ...";
  ...
  describe('detectStatementPeriod', () => {
    ...
    it('should use fallback logic with scattered dates', async () => {
      const text = "Transaction on 01/05/2023. Another one on January 10, 2023. And a final one 01-15-2023.";
      const period = await pdfService['detectStatementPeriod'](text);
    ...
    it('should return null if no period found', async () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('Could not determine statement period'));
    });
    ...
    it('should return null if start date is after end date from primary pattern', async () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('Parsed dates from primary pattern are in wrong order'));
    ...
    it('should return null from fallback if only one unique date is found', async () => {
      const text = "Transaction on 01/05/2023. Another one on 01/05/2023. And a final one 01/05/2023.";
      const period = await pdfService['detectStatementPeriod'](text);
      expect(period).toBeNull();
      expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('Fallback logic resulted in start date not before end date or only one unique date value.'));
    });
    ...
    it('should detect period with "activity between DATE and DATE"', async () => {
      const text = "This statement shows activity between 05/01/2023 and 05/31/2023 for your account.";
      const period = await pdfService['detectStatementPeriod'](text);
  ...
  describe('preprocessImage', () => {
    ...
    it('should fallback to basic processing if cv is undefined', () => {
      ...
      expect(logger.error).toHaveBeenCalledWith('OpenCV (cv) is not loaded. Skipping advanced preprocessing.');
    });
