      ...
      const filename = await BackupService.createBackup(
        {
          ...backupOptions,
          filename:
            backupOptions.filename ||
            `budget-backup-${new Date().toISOString().split('T')[0]}.json`,
        },
        setBackupProgress,
      );
              ...
              <CardContent className='space-y-4'>
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setBackupOptions((prev) => ({
                            ...prev,
                            includeRecurringPreferences: checked,
                          }))
                        }
                      />
                        ...
                        {passwordStrength && (
                          <div className='space-y-1'>
                            <div className='flex items-center space-x-2'>
                              ...
                              <span
                                className={`text-sm ${getPasswordStrengthColor(passwordStrength.level)}`}
                              >
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setBackupOptions((prev) => ({ ...prev, filename: e.target.value }))
                    }
                ...
                <Button onClick={handleCreateBackup} disabled={isProcessing} className='w-full'>
                  <Download className='h-4 w-4 mr-2' />
          ...
          <TabsContent value='restore' className='space-y-6'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Import data from a previous backup file.</CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                {/* File Selection */}
                <div className='space-y-2'>
                        ...
                        <div className='space-y-2'>
                          ...
                          {validationResult.summary && (
                            <div className='space-y-1 text-sm'>
                              ...
                              <div>
                                Transactions: {validationResult.summary.counts.transactions}
                              </div>
                              ...
                              <div>
                                Date Range: {validationResult.summary.dateRange.earliest} to{' '}
                                {validationResult.summary.dateRange.latest}
                              </div>
                            </div>
                          )}
                        </div>
                ...
                {!restoreOptions.mergeData && (
                  <Alert variant='destructive'>
                    <AlertTriangle className='h-4 w-4' />
                    <AlertDescription>
                      Warning: This will replace ALL existing data with the backup data. This action
                      cannot be undone.
                    </AlertDescription>
                  </Alert>
                )}
                        ...
                        <div className='ml-6 space-y-2'>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setSchedule((prev) => ({
                                ...prev,
                                keepCount: parseInt(e.target.value) || 10,
                              }))
                            }
                          />
                        </div>
