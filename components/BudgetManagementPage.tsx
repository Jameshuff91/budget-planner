  ...
  const handleSaveBudget = useCallback(
    async (categoryId: string) => {
      ...
      if (budgetString === undefined) {
        ...
        toast({
          title: 'Error',
          description: 'Could not find budget value to save.',
          variant: 'destructive',
        });
        return;
      }
      ...
      if (budgetString.trim() === '') {
        ...
        if (isNaN(numValue)) {
          ...
          setBudgetInputs((prev) => ({
            ...prev,
            [categoryId]: (originalCategory?.budget || '').toString(),
          }));
          return;
        }
      }
                ...
                (
                  ...
                  >
                    <Label
                      ...
                      className='text-lg font-medium mb-2 sm:mb-0 sm:mr-4'
                    >
                      {category.name}
                    </Label>
                    <Input
                      ...
                      type='number'
                      value={
                        budgetInputs[category.id] !== undefined ? budgetInputs[category.id] : ''
                      }
