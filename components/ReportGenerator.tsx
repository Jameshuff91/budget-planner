...
export default function ReportGenerator({ className }: ReportGeneratorProps) {
  ...
  const setDateRange = (type: 'current-month' | 'last-month' | 'current-year' | 'last-3-months' | 'last-6-months') => {
    const now = new Date();
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Button variant="outline" size="sm" onClick={() => setDateRange('current-month')}>
                      Current Month
                    </Button>
                    <Button variant="outline" size="sm" onClick={() => setDateRange('last-month')}>
                      Last Month
                    </Button>
                    <Button variant="outline" size="sm" onClick={() => setDateRange('current-year')}>
                      Current Year
                    </Button>
                    <Button variant="outline" size="sm" onClick={() => setDateRange('last-3-months')}>
                      Last 3 Months
                    </Button>
                  </div>
                </div>
            ...
            <div className="border rounded-lg p-4 bg-gray-50">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{reportData.potentialRecurringTransactions.length}</span>
                </div>
              </div>
            </div>
          </TabsContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="cursor-pointer hover:shadow-md transition-shadow">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Comprehensive monthly financial analysis with category breakdowns and budget vs. actual comparisons.
                    </p>
                ...
                <Card className="cursor-pointer hover:shadow-md transition-shadow">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Focused report for tax season with deductible categories and detailed transaction records.
                    </p>
                    <Button size="sm" variant="outline" onClick={() => {
                      setReportType('yearly');
                ...
                <Card className="cursor-pointer hover:shadow-md transition-shadow">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Annual overview focusing on savings rate, investment tracking, and net worth analysis.
                    </p>
                    <Button size="sm" variant="outline" onClick={() => {
                      setReportType('yearly');
                      setIncludeCharts(true);
                ...
                <Card className="cursor-pointer hover:shadow-md transition-shadow">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Basic report with essential information and minimal formatting for external use.
                    </p>
                    <Button size="sm" variant="outline" onClick={() => {
                      setExportFormat('csv');
                      setIncludeCharts(false);
