          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">{formatCurrency(yearOverYearStats.previousYearTotal)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">{selectedYear}:</span>
                <span className="font-semibold">{formatCurrency(yearOverYearStats.currentYearTotal)}</span>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">{selectedYear - 1}:</span>
                <span className="font-semibold">{formatCurrency(yearOverYearStats.previousIncomeTotal)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">{selectedYear}:</span>
                <span className="font-semibold">{formatCurrency(yearOverYearStats.currentIncomeTotal)}</span>
              </div>
              <div className="flex justify-between items-center pt-2 border-t">
                <span className="text-sm font-medium">Change:</span>
                <div className="flex items-center gap-1">
        ...
        <CardContent>
          <div className="space-y-2">
            {comparisonData.map((data, index) => {
              ...
              const percentChange = data[`${selectedYear - 1}`] > 0
                ...
                <div key={index} className="flex items-center justify-between py-2 border-b last:border-0">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-sm text-muted-foreground">
                      {formatCurrency(data[`${selectedYear - 1}`])} → {formatCurrency(data[selectedYear])}
                    </span>
