...
async function checkPlaidConfig(page: Page): Promise<boolean> {
  ...
  const alert = page.locator('div[role="alert"]').filter({ hasText: 'Plaid integration requires API credentials' });
...
test.describe('Plaid Bank Connection', () => {
  ...
  test('should display Bank Connections section in Settings', async ({ page }) => {
    ...
    await expect(page.getByText('Connect your bank accounts to automatically import transactions')).toBeVisible();
  ...
  test('should show how it works information', async ({ page }) => {
    ...
    const bankConnectionsSection = page.locator('div').filter({ hasText: 'Bank Connections' }).filter({ hasText: 'Connect your bank accounts' });
    ...
    await expect(bankConnectionsSection.getByText('Securely connect your bank using Plaid').first()).toBeVisible();
    await expect(bankConnectionsSection.getByText('Automatically import transactions daily').first()).toBeVisible();
    await expect(bankConnectionsSection.getByText('Categorize transactions with AI').first()).toBeVisible();
    await expect(bankConnectionsSection.getByText('No manual CSV/PDF uploads needed').first()).toBeVisible();
    await expect(bankConnectionsSection.getByText('Bank-level encryption and security').first()).toBeVisible();
  });
  ...
  test('should handle successful bank connection and display linked account', async ({ page }) => {
    ...
    const accountCard = page.locator('div').filter({ hasText: 'Test Bank' }).filter({ hasText: '...1234' });
  ...
  test('should handle sync with no new transactions', async ({ page }) => {
    ...
    const accountCardAfterSync = page.locator('div').filter({ hasText: 'Test Bank' }).filter({ hasText: '...1234' });
  ...
  test('should handle multiple connected accounts', async ({ page }) => {
    ...
    const testBankButtons = page.locator('div').filter({ hasText: 'Test Bank' }).filter({ hasText: '...1234' }).locator('button[type="button"]').filter({ hasNot: page.locator('[role="tab"]') });
    const anotherBankButtons = page.locator('div').filter({ hasText: 'Another Bank' }).filter({ hasText: '...5678' }).locator('button[type="button"]').filter({ hasNot: page.locator('[role="tab"]') });
