...
test.describe('Mobile View Visual Regression Tests', () => {
  ...
  test('Mobile - navigation menu', async ({ page }) => {
    ...
    const menuButton = await page.locator('[data-testid="mobile-menu-toggle"], [aria-label="Menu"], button:has-text("Menu")').first();
  ...
  test('Mobile - modal/dialog view', async ({ page }) => {
    ...
    const modalTrigger = await page.locator('button:has-text("Export"), button:has-text("Settings")').first();
