...
test.describe('Smart Categorization Settings', () => {
  ...
  test('should display smart categorization settings in Settings tab', async () => {
    ...
    await expect(page.locator('text=Smart Categorization (AI-Powered)')).toBeVisible();
    await expect(
      page.locator('text=Use OpenAI to automatically categorize your transactions'),
    ).toBeVisible();
    ...
    const enableSwitch = page.locator(
      'switch[id="smart-categorization"], input[id="smart-categorization"]',
    );
  ...
  test('should save settings and persist in localStorage', async () => {
    ...
    await expect(
      page.locator('text=Smart categorization settings have been updated'),
    ).toBeVisible();
  ...
  test('should show how it works information', async () => {
    ...
    await expect(
      page.locator('text=Learns from patterns in your transaction history'),
    ).toBeVisible();
